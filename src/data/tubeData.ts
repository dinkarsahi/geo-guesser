...
// rights 2026, and Geomni UK Map data (c) and database rights
// 2026 — the attribution TfL's licence asks for, printed on /credits.
...
export const tubeLineDefs: TubeLineDef[] = [
  {
    "id": 1,
    "name": "Bakerloo",
    "color": "#B36305"
...
export const tubeStationsRaw: TubeStationRaw[] = [
  {
    "name": "Acton Town",
    "lat": 51.5031,
    "lng": -0.2805,
